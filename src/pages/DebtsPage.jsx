...
const DebtsPage = () => {
    ...
    const fetchTotalDeudas = async () => {
        if (!clienteId) return;
        try {
            const response = await fetch(`http://backend.cobros.myccontadores.cl/api/deudas/usuario/${clienteId}/total`);
            if (!response.ok) {
    ...
    const fetchDebts = async () => {
        if (!clienteId) return;
        try {
            const response = await fetch(`http://backend.cobros.myccontadores.cl/api/deudas/usuario/${clienteId}`);
            if (!response.ok) {
    ...
    const filtrarPorFechas = async () => {
        ...
        try {
            const response = await fetch(`http://backend.cobros.myccontadores.cl/api/deudas/filtro-fechas?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`);
            if (!response.ok) {
    ...
    const mostrarPendientes = async () => {
        try {
            const response = await fetch(`http://backend.cobros.myccontadores.cl/api/deudas/usuario/${clienteId}/pendientes`);
            if (!response.ok) {
    ...
    const handleAddDebt = async (debtData) => {
        try {
            const response = await fetch(`http://backend.cobros.myccontadores.cl/api/deudas`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    ...debtData,
