        ...
        const fetchClientData = async () => {
            try {
                ...
                const [clientResponse, indicatorsResponse, movementsResponse] = await Promise.all([
                    fetch(`http://backend.cobros.myccontadores.cl/api/clientes/${clienteId}`),
                    fetch(`http://backend.cobros.myccontadores.cl/api/clientes/${clienteId}/indicadores`),
                    fetch(`http://backend.cobros.myccontadores.cl/api/clientes/${clienteId}/movimientos`),
                ]);
