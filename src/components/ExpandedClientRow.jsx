...
function ExpandedClientRow() {
  return (
    <div className="flex flex-col pb-2.5 mt-5 w-full bg-white rounded-xl border border-solid border-slate-200 shadow-[0px_2px_9px_rgba(0,0,0,0.03)] max-md:max-w-full">
