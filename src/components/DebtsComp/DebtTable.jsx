...
const DebtTable = ({ debts = [], honorariosContables = [], clienteId }) => {
    ...
    const handleViewDetails = async (debt) => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/api/deudas/${debt.deudaId}/detalle`);
            if (!response.ok) {
    ...
    const confirmDeleteHonorario = async () => {
        try {
            const response = await fetch(`hhttp://localhost:8080/api/honorarios/${honorarioToDelete.honorarioId}`, {
                method: "DELETE",
            });
            if (!response.ok) {
    ...
    const confirmDeleteDebt = async () => {
        try {
            const response = await fetch(`http://localhost:8080/api/deudas/${debtToDelete.deudaId}`, {
                method: "DELETE",
            });
            if (!response.ok) {
    ...
    const handleRegisterPayment = async (e) => {
        ...
        try {
            const response = await fetch(
                `http://localhost:8080/api/honorarios/${selectedHonorario.honorarioId}/pagos`,
    ...
    const handleViewHonorarioInfo = async (honorarioId) => {
        try {
            const response = await fetch(`http://localhost:8080/api/honorarios/${honorarioId}/detalle`);
            if (!response.ok) {
    ...
    const descargarComprobante = async (pagoId) => {
        try {
            const response = await fetch(`http://localhost:8080/api/honorarios/pagos/comprobante/${pagoId}`);
            if (!response.ok) {
    ...
    const handleViewMonthDetails = async (honorarioId, mes) => {
        try {
            const response = await fetch(`http://localhost:8080/api/honorarios/${honorarioId}/mes/${mes}`);
            if (!response.ok) {
